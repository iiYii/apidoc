...
use yii\apidoc\templates\getyii\ApiRenderer;
use yii\apidoc\templates\getyii\SideNavWidget;
...
$this->beginContent('@yii/apidoc/templates/getyii/layouts/main.php', isset($type) ? ['type' => $type] : []); ?>
